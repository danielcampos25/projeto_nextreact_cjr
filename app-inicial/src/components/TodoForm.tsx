...
const TodoForm = ({addTodo}:any) => {
  ...
  return( 
    ...
    <button
      type="submit"
      className="text-[#383736] w-20 bg-[#de6c5c] border-2 border-black p-2 font-medium uppercase cursor-pointer h-12 rounded-r-full hover:text-[#ffffff]  transition ease-in-out delay-250 bg-inherit  hover:bg-[#de6c5c] duration-250"
    >
